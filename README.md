...
4) Ручная разметка тестовой выборки предоставлена в папке **./manual_segmentation**

5) **Альтернативный проект - детекция зданий (detection.ipynb)**  - не используется для предсказания площади  
